...
const NODE_SUITES = [
  ...
  ['tests/icefall.mjs', 'buz düşmesi'],
  ['tests/gear-sea.mjs', 'denizin üç gücü'],
  ['tests/wardrobe.mjs', 'gardırop'],
  ['tests/eddy.mjs', 'girdap'],
  ['tests/sodden.mjs', 'ıslak buz'],
  ['tests/roost.mjs', 'dağın kuşu'],
  ['tests/bait.mjs', 'çürük balıklar'],
  ['tests/shaft.mjs', 'baca bütçesi'],
  ['tests/headroom.mjs', 'sıçrayış tavanı'],
